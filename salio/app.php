    ...
    class humano{
        ...
        public function __get(string $name){
            ...
            if (property_exists($this, $name)) {
                return "'name' es una propiedad de la clase.";
            } else {
                echo "'propiedad' no es una propiedad de la clase.";
            }           
            if (method_exists($this, $name)) {
                echo "'name' es un método de la clase.";
            } else {
                echo "'metodo' no es un método de la clase.";
            }
        }
    }
    $extruct = array(
